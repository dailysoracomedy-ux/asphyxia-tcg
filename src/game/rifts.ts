...
const RIFT_DEFS: Record<RiftSpaceId, RiftSpace> = {
  CivilWar: {
    ...
    shortDescription: 'Behind on O2? Choose +1 Momentum or +100 first attack.',
  },
  HumanError: {
    id: 'HumanError',
    name: 'Human Error',
    ...
    shortDescription: 'First Special each turn: choose +1 Momentum or +100 next attack.',
  },
  ControlConflict: {
    id: 'ControlConflict',
    ...
    shortDescription: 'Lock a Support for +1 Momentum. Locked Supports still give Sync.',
  },
  EchoRiot: {
    id: 'EchoRiot',
    name: 'Echo Riot',
    ...
    shortDescription: 'Self-O2 damage hits harder, but fuels Momentum.',
  },
  WhiteRoomCollapse: {
    ...
    shortDescription: 'Choke fuels Momentum, but heavy Choke decays.',
  },
  RecursiveFailure: {
    id: 'RecursiveFailure',
    ...
    shortDescription: 'Second card fuels Momentum, but glitches your Apex.',
  },
};
