...
export const TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    text: 'O2 is your life total. If your O2 hits 0, you lose. Your goal: break through enemy Apexes and reduce your opponent\u2019s O2 to 0. This tutorial plays itself - just click Continue after reading each step to move on.',
  },
  {
    id: 'play-apex',
    title: 'Playing an Apex',
    text: 'Street-Beast enters play automatically. Apexes are your main fighters - they attack, defend, and protect your O2.',
  ...
  },
  {
    ...
    text: 'Dead Battery enters play automatically. Engines provide Sync during Combat - more Sync unlocks bigger attacks.',
    onEnter: () => tutorialRunFullyScriptedTurn('player1', [{ kind: 'playSupport', defId: 'nu-dead-battery' }]),
  },
  {
    id: 'enter-combat',
    title: 'Entering Combat',
    text: 'Dead Battery gives 1 Sync during Combat, unlocking Street-Beast\u2019s stronger attack.',
  ...
  },
  {
    ...
    text: (s) => {
      ...
      return apexBroken
        ...
        : 'Street-Beast uses Neon Pounce - its 1-Sync attack - against the enemy Apex. Damage compared to DEF decides the result.';
    },
  ...
  },
  {
    ...
    text: 'Plasma Edge attaches automatically. Equips attach underneath an Apex and upgrade that fighter permanently, staying visible as a flap so both players can track it.',
    onEnter: () => tutorialRunFullyScriptedTurn('player1', [{ kind: 'playEquip', defId: 'nu-plasma-edge' }]),
  },
  {
    id: 'play-special',
    title: 'Playing a Special',
    text: 'Overclock plays automatically. Specials create powerful one-time effects - only one can be played per turn. Overclock arms your next attack with bonus damage, but costs O2 when it resolves.',
  ...
  },
  {
    ...
    text: 'Reacts are played during your opponent\u2019s turn, right as something important happens - usually an attack. Watch what happens next: the opponent attacks again, and this time the game automatically plays a React (Glitch Step) to reduce the incoming damage.',
  },
  {
    id: 'opponent-turn-2',
    ...
    text: (s) => {
      ...
      return survived
        ...
        : 'Watching the opponent attack again, and the game automatically responding with a React...';
    },
    onEnter: () => {
      tutorialEnsureReactReady();
