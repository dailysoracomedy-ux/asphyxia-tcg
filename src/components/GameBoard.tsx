...
export default function GameBoard() {
  ...
  function onOwnApexPointerDown(e: React.PointerEvent, instanceId: string) {
    if (mode.kind !== 'attackAwaitingTarget' || mode.attackerId !== instanceId) return;
    if (blockedByTutorial() || isActionLocked()) return;
    const source: DragSource = { kind: 'apex-attack', playerId: viewerBottomId, instanceId, attackId: mode.attackId };
    beginPotentialDrag(e, source, legalZonesFor(state, source));
  }
