    ...
    >
      ...
      <div className="grid grid-cols-2 items-stretch">
        ...
        >
          ...
          {/* Giant O2 loss popups - anchored to the panel, scaled by magnitude */}
          {o2Events.map((e) => (
            <span
              key={e.id}
              className={`${popupClass(e.label)} absolute left-1/2 bottom-full z-40 pointer-events-none font-mono font-black whitespace-nowrap`}
              style={{ color: '#fb923c' }}
            >
              {e.label}
            </span>
