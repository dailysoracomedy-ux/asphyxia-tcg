...
function main() {
  ...
  for (const o2 of O2_LEVELS) {
    ...
    const PAIRINGS: [Faction, Faction][] = [["Neon Underground", "Dark White"], ["Neon Underground", "Synth Ascendancy"], ["Neon Underground", "Neon Underground"]];
